...
from wtforms import TextField, BooleanField, PasswordField, SelectField, TextAreaField, validators
#
# from wtforms import StringField, TextField, SubmitField, PasswordField, SelectField, TextAreaField
